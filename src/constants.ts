 ...
 * Mirrors `fbx_utils.py` top-level constants.
 */
...
// Sub-section versions for Geometry layer elements. From fbx_utils.py.
...
export const RIGHT_HAND_AXES = {
  // [upStr, forwardStr] -> { up, front, coord }
  ...
  "Z|Y":   { up: [2, 1],  front: [1, -1], coord: [0, 1]  }, // Blender's native
  "-Z|-X": { up: [2, -1], front: [0, 1],  coord: [1, -1] },
  "-Z|X":  { up: [2, -1], front: [0, -1], coord: [1, 1]  },
  "-Z|-Y": { up: [2, -1], front: [1, 1],  coord: [0, 1]  },
  "-Z|Y":  { up: [2, -1], front: [1, -1], coord: [0, -1] },
...
export const FBX_FRAMERATES = [
  ...
  { fps: 48.0,             mode: 5  },
  { fps: 30.0,             mode: 6  },
  { fps: 30.0 / 1.001,     mode: 9  }, // NTSC color
  { fps: 25.0,             mode: 10 },
  { fps: 24.0,             mode: 11 },
