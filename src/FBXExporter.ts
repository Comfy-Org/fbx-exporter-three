...
// Three.js types referenced structurally to avoid baking a specific
// @types/three version into our published .d.ts. Real callers pass actual
// Object3D / AnimationClip instances; TS in their project resolves the
// names via their own three.js install.
