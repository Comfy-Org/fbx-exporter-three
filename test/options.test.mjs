// User-facing options round-trip: verify every option emits / suppresses the
// right FBX structures. Mirrors Blender's `use_*` operator switches.
//
...
test('customProperties: true → userData written as U-flagged P records', () => {
  ...
  // nested object → JSON-stringified into KString fallback
